...
HD_PWD='C:/Users/natha/VivadoProjects/Everything/Everything.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPIslave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPIslave.tcl -notrace
