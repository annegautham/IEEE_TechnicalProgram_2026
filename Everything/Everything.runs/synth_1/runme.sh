...
HD_PWD='C:/Users/natha/VivadoProjects/Everything/Everything.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPIslave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPIslave.tcl
